...
Then there's career risk. Take fund management for example. The turnover rate of mutual funds across the much of the world has been going up. Take a look at this chart, this is for US funds, but it's the same [in India][11] as well. A turnover rate of 100% means that the fund manager is changing the portfolio every year. ![](/blog-images/MF-turnover.webp) 
